...
/*--------------------
 ...
 ---------------------*/
#define MAX        (SIZE_DATA_SECTION/sizeof(int)/2)
#define NUM_SORT   5

uint8_t data[SIZE_DATA_SECTION]; // this should be set to some nice values generated from rand() on host like = {}

uint64_t size_memory_application_task1 = SIZE_DATA_SECTION; // max size: SIZE_DATA_SECTION
void *memory_application_task1 = (void*)data;

int *orig = (int*)data;
int *copy = (int*)(((uint64_t)data) + (MAX));
...
/*----------------------------  function ------------------------------------
 ...
 Calls: None
 ----------------------------------------------------------------------------*/
static void cpy_array( int const arr[], int to_arr[], int array_size )
{
  int i;
...
/*----------------------------  function ------------------------------------
 ...
 ----------------------------------------------------------------------------*/
static void bubble_sort( int a[], int array_size )
{
  int i, j, tmp;
...
/*----------------------------  function ------------------------------------
 ...
 ----------------------------------------------------------------------------*/
static void shell_sort(int numbers[], int array_size)
{
...
/*----------------------------  function ------------------------------------
 ...
 Calls: q_sort
 ----------------------------------------------------------------------------*/
static void quick_sort(int numbers[], int array_size)
{
...
/*----------------------------  function ------------------------------------
 ...
 Calls: qsort
 ----------------------------------------------------------------------------*/
//static void stdlib_qsort( int numbers[], int array_size )
//{
//
...
/*----------------------------  function ------------------------------------
 ...
 Calls: None
 ----------------------------------------------------------------------------*/
static void execute_sort( int const orig[], int copy[], int array_size,
