...
#if defined(CONFIG_ARM) || defined(CONFIG_ARM64)
	/* Set root_cell coloring description */
	printk("Enable: Checking color params\n");
	root_cell->coloring_desc.fragment_unit_size = \
		config->platform_info.coloring_desc.fragment_unit_size;
	root_cell->coloring_desc.fragment_unit_offset = \
		config->platform_info.coloring_desc.fragment_unit_offset;
	root_cell->coloring_desc.cachesize = \
		config->platform_info.coloring_desc.cachesize;
	printk("VALUES:\nf_size: 0x%llx\nf_offset: 0x%llx\ns_cache: 0x%llx\n",
		root_cell->coloring_desc.fragment_unit_size,
		root_cell->coloring_desc.fragment_unit_offset,
		root_cell->coloring_desc.cachesize);
