 ...
 *
 *
 * NOTE: Add "mem=5000M vmalloc=512M" to the kernel command line.
 *
 */
...
struct {
	...
	.mem_regions = {
		...
		/* System RAM */ {
			...
			.size = 0x138a00000, // 5 GiB
			.flags = JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE |
				JAILHOUSE_MEM_EXECUTE,
		},
		/* Inmates */ {
			.phys_start = 0x1bca00000,
			.virt_start = 0x1bca00000,
